...
public class AuthController {
    ...
    public ResponseEntity<?> register(@Valid @RequestBody RegisterRequest req) {
        try {
            ...
            Role targetRole = req.getRole() != null ? req.getRole() : Role.LITIGANT;
            if (targetRole == Role.ADMIN || targetRole == Role.SUPER_JUDGE || targetRole == Role.TECH_ADMIN || targetRole == Role.POLICE) {
                targetRole = Role.LITIGANT;
            }

...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // 3. Allow all headers in CORS for maximum API integration compatibility
                        ...
                        .contentSecurityPolicy(csp -> csp
                                .policyDirectives(
                                        "default-src 'self'; " +
                                                ...
                                                "connect-src 'self' http://localhost:8080 ws://localhost:8080 http://localhost:5173 https://cdn.jsdelivr.net https://nyaysetubackend.onrender.com; " +
